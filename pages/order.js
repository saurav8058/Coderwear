        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            ...
            <div className="flex border-t border-gray-200 py-2">
              <span className="text-gray-500">WearThe Code(X,XL)</span>
              <span className="ml-auto text-gray-900">1</span>
              <span className="ml-auto text-gray-900">₹499</span>
            </div>
            <div className="flex border-t border-gray-200 py-2">
              <span className="text-gray-500">MugThe Code(X,XL)</span>
              <span className="ml-auto text-gray-900">1</span>
              <span className="ml-auto text-gray-900">₹599</span>
            </div>
            <div className="flex border-t border-b mb-6 border-gray-200 py-2">
              <span className="text-gray-500">Hodiee Code(X,XL)</span>
              <span className="ml-auto text-gray-900">1</span>
          ...
          <img
            alt="ecommerce"
            className=" w-40 h-40 object-cover mx-40 mt-40  rounded"
            src="https://m.media-amazon.com/images/I/71+0ZxjU54L._AC_UL400_.jpg"
          />
        </div>
      </div>
    </section>
